...
//running angular
const path_to_static = path.join(
  __dirname,
  "dist/urbanyog-custo-engage-frontend"
);
...
app.post(
  "/getProductReviewStarCount/:id",
  ProductReviewController.getReviewStarCount
);
...
app.post(
  "/getProductReviewImg/all",
  ProductReview_fileUploadController.getProductReview_fileUpload
);
app.post(
  "/postProductReviewImg/:id",
  ProductReview_fileUploadController.postProductReview_fileUpload
);
app.post(
  "/postSingleProductReviewImg/:id",
  ProductReview_fileUploadController.postSingleRevImg
);
//api by harish
app.post(
  "/get_product_rev_img",
  ProductReview_fileUploadController.getProductReviewImages
);

//Customer controller endpoints
app.post("/getShopifyCustomers", customerController.getShopifyCustomers);
app.post(
  "/getCustomerDetailsForWebsite",
  customerController.getCustomerDetailsForWebsite
);
...
app.post(
  ...
  customerAddressController.updateCustomerAddressType
);
...
app.post(
  "/getProductVarientMaster/all",
  product_varientController.getAllVarients
);
...
//product-suggestion
app.post(
  "/getProductSuggestion/all",
  productSuggestionController.getAllProductSuggestion
);
app.post(
  "/getProductSuggestion/:id",
  productSuggestionController.getProductSuggestionByPid
);
app.post(
  "/createProductSuggestionDetails",
  productSuggestionController.createProductSuggestionDetails
);
app.post(
  "/updateProductSuggestionDetails",
  productSuggestionController.updateProductSuggestionDetails
);
app.post(
  "/deleteProductSuggestionDetails",
  productSuggestionController.deleteProductSuggestionDetails
);
app.post(
  "/createFrequentlyBroughtCounter",
  productSuggestionController.createFrequentlyBroughtCounter
);
app.post(
  "/getFrequentlyBroughtCounter",
  productSuggestionController.getFrequentlyBroughtCounter
);

//product-review-img
app.post(
  "/postProductReview_img/:id",
  productReview_fileUploadController.postProductReview_fileUpload
);
app.post(
...
app.post(
  "/getCust_qr_scan_order",
  cust_qr_scan_orderController.getAll_cust_qrscanned_order
);
app.post(
  "/createCust_qr_scan_order",
  cust_qr_scan_orderController.create_cust_qr_scanned_order
);
...
app.post(
  "/createSurveyEmailRequest",
  surveyController.createSurveyEmailRequest
);
...
app.post(
  ...
  customerWalletHistoryController.getWalletHistoryDetails
);
app.post("/addWalletHistory", customerWalletHistoryController.addWalletHistory);
app.post(
  "/updateWalletHistory",
  customerWalletHistoryController.updateWalletHistory
);
app.post(
  "/deleteWalletHistory",
  customerWalletHistoryController.deleteWalletHistory
);
...
app.post(
  "/getWalletCustomerDetails",
  customerWalletController.getWalletCustomerDetails
);
...
app.post(
  "/orderCancelWebhook",
  customerWalletOrderController.orderCancelWebhook
);
app.post(
  "/orderFulfillmentEventWebhook",
  customerWalletOrderController.orderFulfillmentEventWebhook
);
app.post(
  "/convertRewardToDiscount",
  customerWalletOrderController.convertRewardToDiscount
);
...
app.post(
  "/getWalletCountForWebsite",
  websiteWalletController.getWalletCountForWebsite
);
