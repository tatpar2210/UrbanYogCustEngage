...
exports.addWalletHistory = (req, res) => {
  ...
  const schema = Joi.object().keys({
    ...
    storeOrderId: Joi.number()
      .required()
      .error(new Error("Provide store_order_id(number)")),
    ...
    transactionType: Joi.string()
      .required()
      .error(new Error("Provide transactionType(string)")),
    transactionAmount: Joi.number()
      .required()
      .error(new Error("Provide transactionAmount(number)")),
    ...
    transcationStatus: Joi.number()
      .required()
      .error(new Error("Provide transcationStatus(number)")),
  });
...
exports.deleteWalletHistory = (req, res) => {
  ...
  const schema = Joi.object().keys({
    walletHistoryId: Joi.number()
      .required()
      .error(new Error("Provide walletHistoryId(number)")),
  });
