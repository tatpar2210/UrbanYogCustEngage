  ...
  generateQRWithProductImg(req, res) {
    return new Promise((resolve, reject) => {
      ...
      ctx.fillText(
        ...
        2. Or Visit https://urbangabru.in/pages/verify 
        and enter id 223322
      ...
      QRCode.toDataURL(
        "https://www.urbangabru.in/pages/verify?qrid=",
        {
        ...
        for (let i = 0; i < batchQrData.length; i++) {
          pdfArr.push({
            ...
            stack: [
              ...
              // },
              {
                qr: "https://www.urbangabru.in/pages/verify?qrid=" + batchQrData[i].qr_master.dataValues.qr_code,
                fit: '80',
                eccLevel: 'H',
                margin: [118, -52, 5, 20]
              }
  ...
  return new Promise((resolve, reject) => {
    db.sequelize.query(`SELECT LEFT(REPLACE(UUID(), '-', ''), 9) as qrCode`, { type: QueryTypes.SELECT }).then((qrNumber) => {
      ...
      return QRMaster.create({
        ...
        QRCode.toDataURL(
          "https://www.urbangabru.in/pages/verify?qrid=" + qrCode,
          {
            errorCorrectionLevel: "H",
            scale: 1.4,
            margin: 1,
