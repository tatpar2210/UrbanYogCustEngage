...
class OrderCancelService {
  cancelOrderWebsite(req) {
    ...
    return new Promise((resolve, reject) => {
      ...
      return CancelOrder.findAll(cnd)
        .then((result) => {
          if (result.length <= 0) {
            return CancelOrder.create({
              ...
              .then((createCancelOrder) => {
                this.cancelOrdersToShopify(
                  req.body.storeOrderId,
                  ...
                  if (cancelResult == "Not Found") {
                    return CancelOrder.destroy({
                      where: {
                        cancel_order_id:
                          createCancelOrder.dataValues.cancel_order_id,
                      },
                    })
  ...
  getCancelOrderDetails(req, res) {
    return new Promise((resolve, reject) => {
      ...
      CancelOrder.belongsTo(CustomerMaster, {
